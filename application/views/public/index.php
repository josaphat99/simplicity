<div class="intro-section" id="home-section">
    <div class="slide-1" style="background-image: url(<?=base_url("assets/public/images/banner2.jpg")?>);" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="row align-items-center">
                        <div class="col-lg-7 mb-7">
                            <h1 data-aos="fade-up" data-aos-delay="100">Simplicity Technical Institute</h1>
                            <h3 data-aos="fade-up" data-aos-delay="100">Knowledge and Innovation</h3>
    ...
    <div class="container">
        <div class="row mb-5 justify-content-center">
            <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay>
                <h2 class="section-title">What You need is Us!</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="owl-carousel col-12 nonloop-block-14">
                ...
                <div class="course bg-white align-self-stretch">
                    ...
                    <div class="course-inner-text py-4 px-4">
                        <span class="course-price">4 years</span>
                        <h3><a href="#">Electrical and Computing</a></h3>
                        <p>Lorem ipsum dolor sit amet ipsa nulla adipisicing elit. </p>
                    </div>
                </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 align-self-end" data-aos="fade-left" data-aos-delay="200">
            <img src=<?=base_url("assets/public/images/person_transparent.png")?> alt="Image" class="img-fluid">
        </div>
    </div>
</div>
</div>
